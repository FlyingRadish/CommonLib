...
public class BaseDialog extends Dialog {
    ...
    public static class Builder {
        ...
        protected int positiveBtnTextColorId = R.color.dialog_btn_text_positive;
        protected int negativeBtnTextColorId = R.color.dialog_btn_text_negative;
        ...
        public Builder setButtonInverse() {
            positiveBtnBgId = R.drawable.bg_dialog_btn_negative;
            negativeBtnBgId = R.drawable.bg_dialog_btn_positive;
            positiveBtnTextColorId = R.color.dialog_btn_text_negative_n;
            negativeBtnTextColorId = R.color.dialog_btn_text_positive_n;
            return this;
        }
