...
public class LoadingWheel extends View {
    ...
    private void init() {
        ...
        path = new Path();
        rec = new RectF();
        rec.set(strokeWidth, strokeWidth, rad + strokeWidth, rad + strokeWidth);
    }
    ...
    public void start() {
        LittleAnimator animatorStart = new LittleAnimator(startDuration, new AccelerateDecelerateInterpolator(), 0, 360)
        ...
        LittleAnimator animatorEnd = new LittleAnimator(endDuration, new AccelerateDecelerateInterpolator(), -360, 0)
                .setListener(new LittleAnimator.OnValueUpdateListener() {
                    @Override
                    public void onUpdate(float output) {
                        sweepAngle = output;
