 ...
 */
public abstract class NormalRequest extends BaseRequest<NormalResponse> {


    public NormalRequest(String authority, String path, String mod) {
        super(authority, path, mod);
    }

    public NormalRequest(@NonNull URLHelper urlHelper) {
        super(urlHelper);
    }
